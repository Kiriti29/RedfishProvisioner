...
// func CreatePreseedfile(preseed_file_path string) {

// 	preseed_file, _ := filepath.Abs("./pkg/provisioner/redfish/templates/preseed.tmpl")
// 	input, err := ioutil.ReadFile(preseed_file)
// 	if err != nil {
// 			fmt.Println(err)
// 			//return false, err
// 	}

// 	err = ioutil.WriteFile(preseed_file_path, input, 0644)
// 	if err != nil {
// 			fmt.Println("Error creating", preseed_file_path )
// 			fmt.Println(err)
// 			//return false, err
// 	}
